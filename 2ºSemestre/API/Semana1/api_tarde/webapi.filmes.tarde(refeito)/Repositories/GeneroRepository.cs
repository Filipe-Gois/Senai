...
namespace webapi.filmes.tarde.Repositories
{
    public class GeneroRepository : IGeneroRepository
    {
        ...
        public void AtualizarIdUrl(int _idGenero, GeneroDomain _genero)
        {
            ...
            {
                string QueryUpdateByUrl = "UPDATE Genero SET Genero.Nome = @NomeGenero WHERE Genero.IdGenero = @IdGenero";
                ...
                using(SqlCommand cmd = new SqlCommand(QueryUpdateByUrl, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@NomeGenero", _genero.Nome);
        ...
        public void AtualizarPorIdGenero(GeneroDomain _genero)
        {
            using (SqlConnection con = new SqlConnection(StringConexao))
            {
                string QueryUpdate = "UPDATE Genero SET Genero.Nome = @NomeGenero WHERE Genero.IdGenero = @IdGenero";
                ...
                {
                    cmd.Parameters.AddWithValue("@NomeGenero", _genero.Nome);
                    cmd.Parameters.AddWithValue("@IdGenero", _genero.IdGenero);
        ...
        public GeneroDomain BuscarPorId(int id)
        {
            ...
            using (SqlConnection con = new SqlConnection(StringConexao))
            {
                string QuerySelectById = "SELECT IdGenero, Nome FROM Genero WHERE Genero.IdGenero = @IdGenero";
